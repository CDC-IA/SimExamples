...
script_handle = sim.getObject("/LineTracer/Script[1]")
...
class LineBot:
    ...
    def getSensorData(self):
        return sim.callScriptFunction("getSensorData", script_handle)
...
v = 0.1
bot.setJointsVelocities(v,v)
while bot.getSensorData() == 0:
    pass
bot.setJointsVelocities(0,0)
